...
class APITestClient:
    ...
    def _request(
        self, method: str, path: str, authenticated: bool = True, **kwargs
    ) -> TestResult:
...
def supabase_auth():
    ...
    if not all([SUPABASE_URL, SUPABASE_KEY, TEST_USER_EMAIL, TEST_USER_PASSWORD]):
        pytest.skip(
            "Missing Supabase credentials. Set TEST_USER_EMAIL and TEST_USER_PASSWORD."
        )
...
def test_matter_id(api_client) -> str:
    ...
    if not result.success:
        pytest.skip(
            f"Could not create test matter: {result.error or result.response_data}"
        )
...
class TestHealthEndpoints:
    ...
    def test_root_endpoint(self, api_client: APITestClient, test_report: TestReport):
        ...
        assert result.success, (
            f"Root endpoint failed: {result.error or result.response_data}"
        )
    ...
    def test_health_check(self, api_client: APITestClient, test_report: TestReport):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Health check failed: {result.error or result.response_data}"
        )
    ...
    def test_readiness_check(self, api_client: APITestClient, test_report: TestReport):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Readiness check failed: {result.error or result.response_data}"
        )
    ...
    def test_liveness_check(self, api_client: APITestClient, test_report: TestReport):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Liveness check failed: {result.error or result.response_data}"
        )
    ...
    def test_circuits_status(self, api_client: APITestClient, test_report: TestReport):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Circuits status failed: {result.error or result.response_data}"
        )
...
class TestAuthenticatedHealthEndpoints:
    ...
    def test_authenticated_user_info(
        self, api_client: APITestClient, test_report: TestReport
    ):
        """GET /api/health/me - Get authenticated user info."""
        result = api_client.get("/api/health/me")
        test_report.add_result(result)
        assert result.success, (
            f"Auth user info failed: {result.error or result.response_data}"
        )
        assert "user_id" in result.response_data.get("data", {})

    def test_rate_limits_status(
        self, api_client: APITestClient, test_report: TestReport
    ):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Rate limits status failed: {result.error or result.response_data}"
        )
...
class TestMattersEndpoints:
    ...
    def test_list_matters(self, api_client: APITestClient, test_report: TestReport):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"List matters failed: {result.error or result.response_data}"
        )
    ...
    def test_create_matter(self, api_client: APITestClient, test_report: TestReport):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Create matter failed: {result.error or result.response_data}"
        )
    ...
    def test_get_matter(
        self, api_client: APITestClient, test_matter_id: str, test_report: TestReport
    ):
        """GET /api/matters/{id} - Get matter details."""
        result = api_client.get(f"/api/matters/{test_matter_id}")
        test_report.add_result(result)
        assert result.success, (
            f"Get matter failed: {result.error or result.response_data}"
        )
    ...
    def test_update_matter(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Update matter failed: {result.error or result.response_data}"
        )

    def test_get_tab_stats(
        self, api_client: APITestClient, test_matter_id: str, test_report: TestReport
    ):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Tab stats failed: {result.error or result.response_data}"
        )
    ...
    def test_list_members(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"List members failed: {result.error or result.response_data}"
        )
...
class TestDocumentsEndpoints:
    ...
    def test_list_documents(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"List documents failed: {result.error or result.response_data}"
        )
    ...
    def test_list_documents_with_filters(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"List documents with filters failed: {result.error or result.response_data}"
        )
...
class TestSearchEndpoints:
    ...
    def test_hybrid_search(
        ...
        assert result.status_code in [200, 404], (
            f"Hybrid search failed: {result.error or result.response_data}"
        )
    ...
    def test_bm25_search(
        ...
        test_report.add_result(result)
        assert result.status_code in [200, 404], (
            f"BM25 search failed: {result.error or result.response_data}"
        )
    ...
    def test_semantic_search(
        ...
        test_report.add_result(result)
        assert result.status_code in [200, 404], (
            f"Semantic search failed: {result.error or result.response_data}"
        )
    ...
    def test_rerank_search(
        ...
        test_report.add_result(result)
        assert result.status_code in [200, 404], (
            f"Rerank search failed: {result.error or result.response_data}"
        )
...
class TestEntitiesEndpoints:
    ...
    def test_list_entities(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"List entities failed: {result.error or result.response_data}"
        )
    ...
    def test_list_entities_paginated(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"List entities paginated failed: {result.error or result.response_data}"
        )
...
class TestCitationsEndpoints:
    ...
    def test_list_citations(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"List citations failed: {result.error or result.response_data}"
        )
    ...
    def test_citation_stats(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Citation stats failed: {result.error or result.response_data}"
        )

    def test_citation_summary_by_act(
        self, api_client: APITestClient, test_matter_id: str, test_report: TestReport
    ):
        """GET /api/matters/{id}/citations/summary/by-act - Citations grouped by Act."""
        result = api_client.get(
            f"/api/matters/{test_matter_id}/citations/summary/by-act"
        )
        test_report.add_result(result)
        assert result.success, (
            f"Citation summary failed: {result.error or result.response_data}"
        )

    def test_act_discovery_report(
        self, api_client: APITestClient, test_matter_id: str, test_report: TestReport
    ):
        """GET /api/matters/{id}/citations/acts/discovery - Act Discovery Report."""
        result = api_client.get(
            f"/api/matters/{test_matter_id}/citations/acts/discovery"
        )
        test_report.add_result(result)
        assert result.success, (
            f"Act discovery failed: {result.error or result.response_data}"
        )
...
class TestTimelineEndpoints:
    ...
    def test_list_timeline_events(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"List timeline failed: {result.error or result.response_data}"
        )
    ...
    def test_timeline_stats(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Timeline stats failed: {result.error or result.response_data}"
        )

    def test_full_timeline_with_entities(
        self, api_client: APITestClient, test_matter_id: str, test_report: TestReport
    ):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Full timeline failed: {result.error or result.response_data}"
        )
    ...
    def test_raw_dates(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Raw dates failed: {result.error or result.response_data}"
        )

    def test_classified_events(
        self, api_client: APITestClient, test_matter_id: str, test_report: TestReport
    ):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Classified events failed: {result.error or result.response_data}"
        )

    def test_unclassified_events(
        self, api_client: APITestClient, test_matter_id: str, test_report: TestReport
    ):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Unclassified events failed: {result.error or result.response_data}"
        )
...
class TestSummaryEndpoints:
    ...
    def test_get_summary(
        ...
        assert result.status_code in [200, 404], (
            f"Get summary failed: {result.error or result.response_data}"
        )

    def test_get_summary_verifications(
        self, api_client: APITestClient, test_matter_id: str, test_report: TestReport
    ):
        ...
        test_report.add_result(result)
        assert result.status_code in [200, 404], (
            f"Summary verifications failed: {result.error or result.response_data}"
        )
...
class TestVerificationsEndpoints:
    ...
    def test_verification_stats(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Verification stats failed: {result.error or result.response_data}"
        )

    def test_pending_verifications(
        self, api_client: APITestClient, test_matter_id: str, test_report: TestReport
    ):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Pending verifications failed: {result.error or result.response_data}"
        )
    ...
    def test_list_verifications(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"List verifications failed: {result.error or result.response_data}"
        )

    def test_export_eligibility(
        self, api_client: APITestClient, test_matter_id: str, test_report: TestReport
    ):
        """GET /api/matters/{id}/verifications/export-eligibility - Check export eligibility."""
        result = api_client.get(
            f"/api/matters/{test_matter_id}/verifications/export-eligibility"
        )
        test_report.add_result(result)
        assert result.success, (
            f"Export eligibility failed: {result.error or result.response_data}"
        )
...
class TestJobsEndpoints:
    ...
    def test_list_matter_jobs(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"List matter jobs failed: {result.error or result.response_data}"
        )
    ...
    def test_job_queue_stats(
        ...
        if result.status_code == 404:
            ...
            test_report.add_result(result)
        assert result.status_code in [200, 404], (
            f"Job stats failed: {result.error or result.response_data}"
        )
...
class TestActivityEndpoints:
    ...
    def test_activity_feed(self, api_client: APITestClient, test_report: TestReport):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Activity feed failed: {result.error or result.response_data}"
        )
    ...
    def test_dashboard_stats(self, api_client: APITestClient, test_report: TestReport):
        ...
        test_report.add_result(result)
        assert result.success, (
            f"Dashboard stats failed: {result.error or result.response_data}"
        )
...
class TestNotificationsEndpoints:
    ...
    def test_list_notifications(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"List notifications failed: {result.error or result.response_data}"
        )
...
class TestExportsEndpoints:
    ...
    def test_list_exports(
        ...
        test_report.add_result(result)
        assert result.success, (
            f"List exports failed: {result.error or result.response_data}"
        )
...
class TestOrphanedEndpoints:
    ...
    def test_alias_expanded_search(
        self, api_client: APITestClient, test_matter_id: str, test_report: TestReport
    ):
