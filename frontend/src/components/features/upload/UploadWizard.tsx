...
export function UploadWizard() {
  ...
  const setDocumentType = useUploadWizardStore((state) => state.setDocumentType);
        ...
        {(currentStage === 'REVIEW' || currentStage === 'ACT_DISCOVERY') && (
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger id="document-type" className="w-full" data-testid="document-type-select">
